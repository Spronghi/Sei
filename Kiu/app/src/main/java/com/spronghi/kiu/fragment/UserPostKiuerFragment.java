 ...
 */
public class UserPostKiuerFragment extends ModelFragment<Kiuer> {
    ...
    @Override
    public void setModel(Kiuer model) { kiuer= model; }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup parent, Bundle savedInstanceState) {
        ...
        openText.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ModelFragment<Kiuer> modelFragment = FragmentFactory.getInstance(FragmentControl.LIST_KIUER_USER_OPEN);
        ...
        closedText.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ModelFragment<Kiuer> modelFragment = FragmentFactory.getInstance(FragmentControl.LIST_KIUER_USER_CLOSED);
                modelFragment.setModel(kiuer);
                manager.beginTransaction()
                        .replace(R.id.activity_main_frame_layout, modelFragment, "list_post_kiuer")
                        .addToBackStack(null)
