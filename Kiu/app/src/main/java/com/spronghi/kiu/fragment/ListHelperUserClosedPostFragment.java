 ...
 */
public class ListHelperUserClosedPostFragment extends ModelFragment<Helper> {
    public static final String TAG = ListHelperUserClosedPostFragment.class.getSimpleName();
    ...
    public static class RecyclerTouchListener implements RecyclerView.OnItemTouchListener {
        ...
        private ListHelperUserClosedPostFragment.ClickListener clickListener;

        public RecyclerTouchListener(Context context, final RecyclerView recyclerView, final ListHelperUserClosedPostFragment.ClickListener clickListener) {
